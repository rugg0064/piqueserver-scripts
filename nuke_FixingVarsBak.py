...
def dropNuke(x, y, accuracy, connectionTeam, connection=None):
    ...
    print("my team: %s" %connection.team)
    print("other team: %s" %connection.team.other)
    print("connteamOther: %s" %connectionTeam.other)
    print("== : %s" %(str(connection.team.other == connectionTeam.other)))
